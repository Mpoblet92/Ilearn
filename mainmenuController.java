...
public class mainmenuController {
	...
	@FXML private Button btnPoS, btnLogout, btnAdvisee, btnAdvisor, btnAdmin, btnCourses, btnPref, btnProfile;
	...
	{
		Stage primaryStage = new Stage();
		Parent root = FXMLLoader.load(getClass().getResource("/View/NewProfile.fxml"));
		Scene scene = new Scene(root, 400,400);
		primaryStage.setScene(scene);
		primaryStage.show();
	}
